...
import frc.robot.commands.Shooter.Basic.RunShooterWithPower;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    driverController.R2().whileTrue(new ParallelDeadlineGroup(
      ...
      new RunShooterWithPower(shooter)));
    //driverController.L2().whileTrue(new RevppppperseShooter(shooter));
